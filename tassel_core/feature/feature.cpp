...
//     // double angle = Eigen::Quaterniond::FromTwoVectors(uv, uv_r).angularDistance(
//     //     Eigen::Quaterniond::Identity());
//     // if (angle < min_angle) {
//     //     observations[0].is_stereo = false;
//     // } else {
...
//         Eigen::Vector3d reference_t = state->Rs[start_frame_id] * tic +
//         state->Ps[start_frame_id];
