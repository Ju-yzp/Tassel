#ifndef TASSEL_CORE_FACTOR_MIDPOINT_INTEGRATOR_H_
#define TASSEL_CORE_FACTOR_MIDPOINT_INTEGRATOR_H_
...
// 唯一预积分实现；对象由窗口 vector 直接拥有并随窗口一起重置和搬移。
...
#endif  // TASSEL_CORE_FACTOR_MIDPOINT_INTEGRATOR_H_
